...
func mapError(err error) (int, int, string) {
	...
	case errors.Is(err, domain.ErrForbidden), errors.Is(err, domain.ErrGameMemberRequired), errors.Is(err, domain.ErrParticipantRequired), errors.Is(err, domain.ErrNotOwner), errors.Is(err, domain.ErrOwnerRequired):
	...
	case errors.Is(err, domain.ErrConflict), errors.Is(err, domain.ErrGameSessionFinished), errors.Is(err, domain.ErrGameSessionVoided), errors.Is(err, domain.ErrActiveGameExists), errors.Is(err, domain.ErrGameCapacityFull), errors.Is(err, domain.ErrDuplicateDisplayName), errors.Is(err, domain.ErrCannotLeaveWithNonZeroScore), errors.Is(err, domain.ErrParticipantInactive), errors.Is(err, domain.ErrAlreadyDeactivated), errors.Is(err, domain.ErrIdempotencyConflict), errors.Is(err, domain.ErrFinishRequestPending), errors.Is(err, domain.ErrFinishRequestNotPending):
