...
| Record a score       | Keep participant selection, per-person input, and confirmation on one page; omit the change-preview section to keep this screen compact. Use consistent selected states and control radii. Keep results and submission reachable when the keyboard appears. |
